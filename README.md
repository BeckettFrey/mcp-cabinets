...
- [MCP Service README](mcp-service/README.md): Information about the MCP client and integration logic.

### Documentation
- [Architecture Overview](docs/ARCHITECTURE.md): High-level design and system architecture.
- [Movement](docs/MOVEMENT.md): Project direction, goals, and development philosophy.
